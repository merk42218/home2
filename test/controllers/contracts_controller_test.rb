...
class ContractsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contract" do
    assert_difference('Contract.count') do
      post contracts_url, params: { contract: { date_of_registration: @contract.date_of_registration, price: @contract.price } }
    end
  ...
  test "should update contract" do
    patch contract_url(@contract), params: { contract: { date_of_registration: @contract.date_of_registration, price: @contract.price } }
